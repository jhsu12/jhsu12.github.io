...
**UPDATE: I have successfully create the first version of the chatbox. It is a simple Q&A system that can answer questions about the tournament, teams, and players. It is currently in the works and will be added to the website in the near future. (Here is the [demo](https://www.youtube.com/watch?v=QdP43NTIMro))**
